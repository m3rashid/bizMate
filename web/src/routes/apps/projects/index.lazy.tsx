		...
		<div className="h-min select-none rounded-lg border-2 border-white p-2 shadow-lg hover:border-primary sm:p-3 md:p-4">
			...
			<div className="mt-4 flex w-full flex-wrap gap-2">
				<Tooltip label="Project Guidelines" show="right">
					<Link to="/apps/projects/$projectId/readme" params={{ projectId: props.id.toString() }}>
						<Chip variant="simple">Readme</Chip>
					</Link>
				</Tooltip>

				<Tooltip label="Project Guidelines" show="right">
					<Link to="/apps/projects/$projectId/guidelines" params={{ projectId: props.id.toString() }}>
						<Chip variant="simple">Guidelines</Chip>
					</Link>
				</Tooltip>

				<Tooltip label="Project Guidelines" show="right">
					<Link to="/apps/projects/$projectId/docs" params={{ projectId: props.id.toString() }}>
