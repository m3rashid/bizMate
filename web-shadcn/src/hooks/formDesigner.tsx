import { FormElementInstance, supportedWidgets } from '@/components/modules/forms/builder/constants'
import { Props } from '@/components/modules/forms/builder/exposedProps'
import { StringBoolean } from '@/types/others'
...
const formDesignerAtom = atom<FormDesigner>({
	key: 'formDesigner',
	default: {
		meta: [{ id: '$name$', name: 'input', props: { name: 'name', label: 'Name', descriptionText: 'Please enter your full name here' } }],
		viewType: 'build',
		selectedNode: null,
		rootProps: {
