...
type Form struct {
	...
	SuccessPage            string `json:"successPage" gorm:"column:successPage"`
	FailurePage            string `json:"failurePage" gorm:"column:failurePage"`
	...
	PreviousVersionIDs     string `json:"previousVersionIDs" gorm:"column:previousVersionIDs;default:[]" validate:"required"`
}
